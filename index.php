...
<html lang="ru">
	...
	<body>
			...
			<div class="container">
				<div class="row">
					<div id="contact-form" class="contact-form">
						<div class="contact-form__callback">
							...
							<input class="contact-form__input contact-form__name" type="text" id="name" placeholder="Ваше имя..." required>
							<input class="contact-form__input contact-form__tel" type="tel" id="phone" name="phone" placeholder="Ваш телефон... (___)___-__-__" required>
							<select id="service" class="contact-form__select" name="Наименование заказа">
							...
							<button class="contact-form__button" onclick="sendMail()">оставить заявку</button>
							<div id="alert">Дякуємо за ваш запит!</div>
						</div>
					</div>
				</div>
			</div>
		...
		<script src="form-javascript.js"></script>
		<script src="https://cdn.jsdelivr.net/npm/@emailjs/browser@3/dist/email.min.js"></script>
		<script>
          (function () {
            emailjs.init("tJ11KKgWRvvgZ-Nqe");
          })();
        </script>
	</body>
</html>
